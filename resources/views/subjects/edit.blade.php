            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header">
                        <h3 class="text-center font-weight-light my-4">Edit Subject</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('subjects.update', $subject->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control @error('name') is-invalid @enderror" id="inputSubjectName" type="text" name="name" value="{{ old('name', $subject->name) }}" placeholder="Enter subject name" />
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control @error('description') is-invalid @enderror" id="inputSubjectDescription" name="description" placeholder="Enter subject description" style="height: 100px;">{{ old('description', $subject->description) }}</textarea>
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <button class="btn btn-primary btn-block" type="submit">Update Subject</button>
                                </div>
                            </div>
                        </form>
                    </div>
