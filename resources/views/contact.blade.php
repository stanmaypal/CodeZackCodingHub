        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">{{$contactInfo->about}} <a href="">Download Now</a>.</p>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">+91 {{ $contactInfo->phone}}</p>
                        </div>
                    </div>
                ...
                @endif
                    <form method="POST" action="{{ route('contact.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="date" class="form-control" hidden id="current_date" name="current_date" placeholder="Current Date" value="{{ now()->format('Y-m-d') }}" readonly>
