            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header">
                        <h3 class="text-center font-weight-light my-4">Create Class Issue</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('class_issues.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control @error('issue_date') is-invalid @enderror" id="inputIssueDate" type="date" name="issue_date" value="{{ old('issue_date') }}" placeholder="Select issue date" />
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <button class="btn btn-primary btn-block" type="submit">Create Class Issue</button>
                                </div>
                            </div>
                        </form>
                    </div>
